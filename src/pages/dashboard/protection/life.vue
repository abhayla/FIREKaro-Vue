...
<template>
  <div>
    <SectionHeader title="Protection" subtitle="Life Insurance Policies" icon="mdi-shield-check" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Life Insurance</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">Track term insurance and other life insurance policies.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
