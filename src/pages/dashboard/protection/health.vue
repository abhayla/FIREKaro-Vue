...
<template>
  <div>
    <SectionHeader title="Protection" subtitle="Health Insurance Policies" icon="mdi-shield-check" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Health Insurance</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">Track health insurance for self and family members with adequacy analysis.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
