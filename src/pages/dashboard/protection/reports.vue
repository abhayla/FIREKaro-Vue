...
<template>
  <div>
    <SectionHeader title="Protection" subtitle="Insurance Reports" icon="mdi-shield-check" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Insurance Reports</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">View coverage adequacy reports and policy renewal reminders.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
