...
<template>
  <div>
    <SectionHeader title="Liabilities" subtitle="Loan Management" icon="mdi-credit-card-outline" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Loans</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">Track home loans, car loans, personal loans with EMI and prepayment analysis.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
