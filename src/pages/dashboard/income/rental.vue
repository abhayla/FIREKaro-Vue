...
import RentalOverviewTab from "@/components/income/RentalOverviewTab.vue";
import RentalDetailsTab from "@/components/income/RentalDetailsTab.vue";
  ...
  <div>
    ...
    <v-tabs-window v-model="activeTab">
      <v-tabs-window-item :value="0">
        <RentalOverviewTab @go-to-details="goToDetails" />
      </v-tabs-window-item>
