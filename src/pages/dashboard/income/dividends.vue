...
import DividendOverviewTab from "@/components/income/DividendOverviewTab.vue";
import DividendDetailsTab from "@/components/income/DividendDetailsTab.vue";
  ...
  <div>
    ...
    <v-tabs-window v-model="activeTab">
      <v-tabs-window-item :value="0">
        <DividendOverviewTab @go-to-details="goToDetails" />
      </v-tabs-window-item>
