...
import OtherOverviewTab from "@/components/income/OtherOverviewTab.vue";
import OtherDetailsTab from "@/components/income/OtherDetailsTab.vue";
  ...
  <div>
    ...
    <v-tabs-window v-model="activeTab">
      <v-tabs-window-item :value="0">
        <OtherOverviewTab @go-to-details="goToDetails" />
      </v-tabs-window-item>
