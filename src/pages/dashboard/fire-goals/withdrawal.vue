...
<template>
  <div>
    <SectionHeader title="FIRE & Goals" subtitle="Withdrawal Strategies" icon="mdi-fire" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Withdrawal Strategy</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal" class="mb-4">Compare SWR, Bucket, and VPW withdrawal strategies for FIRE.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
