...
<template>
  <div>
    <SectionHeader title="FIRE & Goals" subtitle="FIRE Reports" icon="mdi-fire" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>FIRE Reports</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">View comprehensive FIRE progress reports and goal tracking.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
