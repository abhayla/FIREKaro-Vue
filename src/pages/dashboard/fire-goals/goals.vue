...
<template>
  <div>
    <SectionHeader title="FIRE & Goals" subtitle="Financial Goals" icon="mdi-fire" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Goals</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal" class="mb-4">Set and track financial goals with SIP recommendations.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
