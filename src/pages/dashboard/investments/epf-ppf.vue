...
<template>
  <div>
    <SectionHeader title="Investments" subtitle="EPF & PPF Accounts" icon="mdi-chart-line" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>EPF & PPF</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">Track your EPF, VPF, and PPF contributions with projections.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
