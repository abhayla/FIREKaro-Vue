...
<template>
  <div>
    <SectionHeader title="Investments" subtitle="Property Investments" icon="mdi-chart-line" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Property</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">Track real estate holdings and property valuations.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
