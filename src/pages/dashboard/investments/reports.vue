...
<template>
  <div>
    <SectionHeader title="Investments" subtitle="Investment Reports" icon="mdi-chart-line" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Investment Reports</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">View portfolio performance, asset allocation, and rebalancing recommendations.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
