...
<template>
  <div>
    <SectionHeader title="Investments" subtitle="Stock Holdings" icon="mdi-chart-line" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Stocks</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">Track your stock holdings and performance.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
