...
<template>
  <div>
    <SectionHeader title="Financial Health" subtitle="Financial Reports" icon="mdi-heart-pulse" :tabs="tabs" />
    <v-card class="mt-6">
      <v-card-title>Financial Health Reports</v-card-title>
      <v-card-text>
        <v-alert type="info" variant="tonal">View comprehensive financial health reports and improvement suggestions.</v-alert>
      </v-card-text>
    </v-card>
  </div>
</template>
