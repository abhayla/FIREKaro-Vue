...
<template>
  <div>
    ...
    <v-row>
      <v-col cols="12" md="3">
        <v-card class="pa-4">
          <div class="text-body-2 text-medium-emphasis">Health Score</div>
    ...
    <v-card class="mt-6">
      <v-card-title>Financial Health Overview</v-card-title>
      <v-card-text>
        <p class="text-medium-emphasis">
          Track your overall financial health score based on 4 key factors.
        </p>
      </v-card-text>
    </v-card>
  </div>
