    ...
    },
    {
      ...
      children: [
        ...
        // Section 2: Non-Salary Income
        {
          ...
          component: () => import('@/pages/dashboard/non-salary-income/index.vue'),
        },
        {
          path: 'non-salary-income/business',
          name: 'non-salary-income-business',
          component: () => import('@/pages/dashboard/non-salary-income/business.vue'),
        },
        {
          path: 'non-salary-income/rental',
          name: 'non-salary-income-rental',
          component: () => import('@/pages/dashboard/non-salary-income/rental.vue'),
        },
        {
          path: 'non-salary-income/capital-gains',
          name: 'non-salary-income-capital-gains',
          component: () => import('@/pages/dashboard/non-salary-income/capital-gains.vue'),
        },
        {
          path: 'non-salary-income/other',
          name: 'non-salary-income-other',
          component: () => import('@/pages/dashboard/non-salary-income/other.vue'),
        },
        {
          path: 'non-salary-income/reports',
          name: 'non-salary-income-reports',
          component: () => import('@/pages/dashboard/non-salary-income/reports.vue'),
        },
        ...
        },
        {
          ...
          component: () => import('@/pages/dashboard/tax-planning/calculator.vue'),
        },
        {
          path: 'tax-planning/deductions',
          name: 'tax-planning-deductions',
          component: () => import('@/pages/dashboard/tax-planning/deductions.vue'),
        },
        {
        ...
        },
        {
          ...
          component: () => import('@/pages/dashboard/investments/mutual-funds.vue'),
        },
        {
        ...
        },
        {
          ...
          component: () => import('@/pages/dashboard/liabilities/credit-cards.vue'),
        },
        {
          path: 'liabilities/debt-payoff',
          name: 'liabilities-debt-payoff',
          component: () => import('@/pages/dashboard/liabilities/debt-payoff.vue'),
        },
        {
        ...
        },
        {
          ...
          component: () => import('@/pages/dashboard/protection/calculator.vue'),
        },
        {
        ...
        // Section 8: Financial Health
        {
          ...
          component: () => import('@/pages/dashboard/financial-health/index.vue'),
        },
        {
          path: 'financial-health/net-worth',
          name: 'financial-health-net-worth',
          component: () => import('@/pages/dashboard/financial-health/net-worth.vue'),
        },
        {
          path: 'financial-health/cash-flow',
          name: 'financial-health-cash-flow',
          component: () => import('@/pages/dashboard/financial-health/cash-flow.vue'),
        },
        {
          path: 'financial-health/banking',
          name: 'financial-health-banking',
          component: () => import('@/pages/dashboard/financial-health/banking.vue'),
        },
        {
          path: 'financial-health/emergency-fund',
          name: 'financial-health-emergency-fund',
          component: () => import('@/pages/dashboard/financial-health/emergency-fund.vue'),
        },
        {
          path: 'financial-health/reports',
          name: 'financial-health-reports',
          component: () => import('@/pages/dashboard/financial-health/reports.vue'),
        },
        ...
        },
        {
          ...
          component: () => import('@/pages/dashboard/fire-goals/calculators.vue'),
        },
        {
        ...
        },
        {
          ...
          component: () => import('@/pages/dashboard/fire-goals/projections.vue'),
        },
        {
          path: 'fire-goals/withdrawal',
          name: 'fire-goals-withdrawal',
          component: () => import('@/pages/dashboard/fire-goals/withdrawal.vue'),
        },
        {
